...
export function NextMeal() {
  ...
  return <Card className="hover:shadow-modern transition-shadow">
      <CardHeader className="pb-3 bg-gray-950">
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="flex items-center justify-between bg-zinc-950">
            <h3 className="font-semibold text-corpoideal-dark text-slate-50">{nextMeal.name}</h3>
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <ul className="space-y-1">
              {nextMeal.foods.map((food, index) => <li key={index} className="text-sm text-corpoideal-dark flex items-center">
          ...
          <Button onClick={() => navigate('/nutrition')} variant="outline" className="w-full border-corpoideal-purple text-corpoideal-purple hover:bg-corpoideal-purple hover:text-white">
