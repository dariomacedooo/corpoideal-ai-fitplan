      ...
      <CardContent>
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4">
            ...
            <Button type="submit" disabled={loading || !email || !password} className="w-full bg-corpoideal-purple hover:bg-corpoideal-darkpurple bg-slate-900 hover:bg-slate-800">
