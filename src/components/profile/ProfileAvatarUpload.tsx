...
export function ProfileAvatarUpload({ name = "U" }: { name?: string }) {
    ...
    <div className="flex flex-col items-center gap-2">
      <div className="relative group">
        ...
        <button
          ...
          className="absolute bottom-0 right-0 bg-cyan-400 cursor-pointer rounded-full p-2 transition hover:bg-cyan-500 shadow group-hover:scale-110"
          onClick={onClick}
        >
